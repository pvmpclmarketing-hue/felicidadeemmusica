...
var client_references_default = {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-BABOH263.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"8f7ba5393f33": async () => {
		const m = await import("./assets/error-boundary-CRd1GyP2.js");
		return {
			get "ErrorBoundary"() {
	...
	"c956316e5fb8": async () => {
		const m = await import("./assets/page-DfL023DL.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"ee6cb3d92c61": async () => {
		const m = await import("./assets/layout-segment-context-DstGCOlh.js");
